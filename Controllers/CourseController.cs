...
//                return BadRequest();
        ...
        public IActionResult Edit(string courseId)
        {
            ...
            var vm = new CourseViewModel(){Course = course, Schedules = schedules};
            return View(vm);
        }
...
//                return BadRequest();
        ...
        public IActionResult CourseArea(string courseId)
        {
            ...
            {
                Course = course, Lectures = lectures, Schedules = schedule, Files = files, HomeworkVm = homeworkVm,
                HomeworkVmForTeacher = homeworkSectionVmForTeacher, Videos = videos, Feedback = feedback, People = people
            };
