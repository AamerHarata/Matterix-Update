    ...
    public partial class AddNewLanguages : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CountriesIsoCode = table.Column<string>(type: "text", nullable: false),
                    CoursesId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryCourse", x => new { x.CountriesIsoCode, x.CoursesId });
                    table.ForeignKey(
                        name: "FK_CountryCourse_Country_CountriesIsoCode",
                        column: x => x.CountriesIsoCode,
                        principalTable: "Country",
                        principalColumn: "IsoCode",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CountryCourse_Courses_CoursesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CountryCourse_CoursesId",
                table: "CountryCourse",
                column: "CoursesId");
        }
